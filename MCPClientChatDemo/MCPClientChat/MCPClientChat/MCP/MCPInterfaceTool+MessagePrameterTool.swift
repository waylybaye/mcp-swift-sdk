...
extension MCPInterface.Tool {
    ...
    */
   private func convertToAnthropicJSONSchema(from jsonObject: [String: MCPInterface.JSON.Value]) -> SwiftAnthropic.MessageParameter.Tool.JSONSchema? {
      guard let typeValue = jsonObject["type"],
            case .string(let typeString) = typeValue,
            let jsonType = SwiftAnthropic.MessageParameter.Tool.JSONSchema.JSONType(rawValue: typeString) else {
         return nil
      }
      ...
      if let patternValue = jsonObject["pattern"],
      ...
      if let constVal = jsonObject["const"],
      ...
      if let multipleOfValue = jsonObject["multipleOf"],
      ...
      // Extract minimum
      var minimum: Int? = nil
      if let minimumValue = jsonObject["minimum"],
      ...
      // Extract maximum
      var maximum: Int? = nil
      if let maximumValue = jsonObject["maximum"],
    ...
    */
   private func convertToAnthropicProperty(from propertyObject: [String: MCPInterface.JSON.Value]) -> SwiftAnthropic.MessageParameter.Tool.JSONSchema.Property? {
      guard let typeValue = propertyObject["type"],
            case .string(let typeString) = typeValue,
            let jsonType = SwiftAnthropic.MessageParameter.Tool.JSONSchema.JSONType(rawValue: typeString) else {
         return nil
      }
      ...
      if let descValue = propertyObject["description"],
      ...
      if let formatValue = propertyObject["format"],
      ...
      if let itemsValue = propertyObject["items"],
      ...
      // Extract required fields
      var required: [String]? = nil
      if let requiredValue = propertyObject["required"],
         case .array(let requiredArray) = requiredValue {
         required = []
         for item in requiredArray {
            if case .string(let field) = item {
      ...
      // Extract pattern
      var pattern: String? = nil
      if let patternValue = propertyObject["pattern"],
         case .string(let patternString) = patternValue {
         pattern = patternString
      }
      ...
      // Extract const
      var constValue: String? = nil
      if let constVal = propertyObject["const"],
         case .string(let constString) = constVal {
         constValue = constString
      }
      ...
      // Extract enum values
      var enumValues: [String]? = nil
      if let enumValue = propertyObject["enum"],
         case .array(let enumArray) = enumValue {
         enumValues = []
         for item in enumArray {
            if case .string(let value) = item {
      ...
      // Extract multipleOf
      var multipleOf: Int? = nil
      if let multipleOfValue = propertyObject["multipleOf"],
         case .number(let multipleOfDouble) = multipleOfValue {
         multipleOf = Int(multipleOfDouble)
      }
      ...
      if let minimumValue = propertyObject["minimum"],
         case .number(let minimumDouble) = minimumValue {
      ...
      if let maximumValue = propertyObject["maximum"],
         case .number(let maximumDouble) = maximumValue {
      ...
      if let minItemsValue = propertyObject["minItems"],
      ...
      if let maxItemsValue = propertyObject["maxItems"],
      ...
      if let uniqueItemsValue = propertyObject["uniqueItems"],
    ...
    */
   private func convertToAnthropicItems(from itemsObject: [String: MCPInterface.JSON.Value]) -> SwiftAnthropic.MessageParameter.Tool.JSONSchema.Items? {
      guard let typeValue = itemsObject["type"],
            case .string(let typeString) = typeValue,
            let jsonType = SwiftAnthropic.MessageParameter.Tool.JSONSchema.JSONType(rawValue: typeString) else {
         return nil
      }
      ...
      // Extract properties
      var properties: [String: SwiftAnthropic.MessageParameter.Tool.JSONSchema.Property]? = nil
      if let propertiesValue = itemsObject["properties"],
         case .object(let propertiesObject) = propertiesValue {
         properties = [:]
         for (key, value) in propertiesObject {
            if case .object(let propertyObject) = value,
      ...
      // Extract pattern
      var pattern: String? = nil
      if let patternValue = itemsObject["pattern"],
         case .string(let patternString) = patternValue {
         pattern = patternString
      }
      ...
      // Extract const
      var constValue: String? = nil
      if let constVal = itemsObject["const"],
         case .string(let constString) = constVal {
         constValue = constString
      }
      ...
      // Extract enum values
      var enumValues: [String]? = nil
      if let enumValue = itemsObject["enum"],
         case .array(let enumArray) = enumValue {
         enumValues = []
         for item in enumArray {
            if case .string(let value) = item {
      ...
      // Extract multipleOf
      var multipleOf: Int? = nil
      if let multipleOfValue = itemsObject["multipleOf"],
         case .number(let multipleOfDouble) = multipleOfValue {
         multipleOf = Int(multipleOfDouble)
      }
      ...
      // Extract minimum
      var minimum: Double? = nil
      if let minimumValue = itemsObject["minimum"],
         case .number(let minimumDouble) = minimumValue {
         minimum = minimumDouble
      }
      ...
      // Extract maximum
      var maximum: Double? = nil
      if let maximumValue = itemsObject["maximum"],
         case .number(let maximumDouble) = maximumValue {
         maximum = maximumDouble
      }
      ...
      // Extract minItems
      var minItems: Int? = nil
      if let minItemsValue = itemsObject["minItems"],
         case .number(let minItemsDouble) = minItemsValue {
         minItems = Int(minItemsDouble)
      }
      ...
      // Extract maxItems
      var maxItems: Int? = nil
      if let maxItemsValue = itemsObject["maxItems"],
         case .number(let maxItemsDouble) = maxItemsValue {
         maxItems = Int(maxItemsDouble)
      }
      ...
      // Extract uniqueItems
      var uniqueItems: Bool? = nil
      if let uniqueItemsValue = itemsObject["uniqueItems"],
         case .bool(let uniqueItemsBool) = uniqueItemsValue {
         uniqueItems = uniqueItemsBool
      }
